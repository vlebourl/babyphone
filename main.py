    ...
    def process_amplitude(self, amplitude: float) -> None:
        ...
        if amplitude > self.threshold:
            ...
            if self.noisycount * INPUT_BLOCK_TIME >= MIN_NOISE_DURATION:
                if (
                    datetime.now() - self.last_events_time > timedelta(seconds=NOISE_EVENT_TIMEOUT)
            ...
            if datetime.now() - self.last_events_time > timedelta(seconds=SPEAKING_TIMEOUT):
