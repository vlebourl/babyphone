...
- Les envois sont **synchrones dans la boucle d'écoute** : une domotique lente ou injoignable bloque l'écoute audio pendant les tentatives. Une limitation de débit et des retries bornés contiennent le problème sans le supprimer. C'est la principale dette de ce choix — le jour où elle fait mal, la sortie est d'émettre depuis un thread avec une file. La cible n'ayant que du Wi-Fi ([ADR-0005](0005-cible-raspberry-pi-3a-plus.md)), ce jour arrivera.
